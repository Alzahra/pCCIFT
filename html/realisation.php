...
<body style="background: url('../Resources/harpe-extr.png') no-repeat fixed center; background-size: cover;">
  ...
  <div class="pi-draggable py-5  section" draggable="true">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="text-primary text-capitalize">Forum &lt;Tunisia 2020&gt;</h1>
  ...
  <div class="py-5 pi-draggable section text-center" draggable="true">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-primary text-capitalize">convention Avec la CCI de bizerte</h1>
  ...
  <div class="pi-draggable py-5  section" draggable="true">
    <div class="container">
      <div class="row">
        <div class="col-md-6"> <img class="img-responsive" src="https://pingendo.com/assets/photos/wireframe/photo-1.jpg" class="img-fluid img-thumbnail"> </div>
        <div class="col-md-6">
          <h1 class="text-primary text-capitalize">Délégation à casserine</h1>
          <p class="lead">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu,
            pretium quis, sem. </p>
        </div>
      </div>
